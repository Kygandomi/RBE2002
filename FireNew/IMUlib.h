...
#define M_X_MIN -2289
#define M_Y_MIN -1356
#define M_Z_MIN -17920
#define M_X_MAX 2488
#define M_Y_MAX 3501
#define M_Z_MAX -12738
...
void Drift_correction(void){
	...
	float Accel_magnitude = sqrt(Accel_Vector[0]*Accel_Vector[0] + Accel_Vector[1]*Accel_Vector[1] + Accel_Vector[2]*Accel_Vector[2]);
	Accel_magnitude = Accel_magnitude / GRAVITY; // Scale to gravity.
	// Dynamic weighting of accelerometer info (reliability filter)
	// Weight for accelerometer info (<0.5G = 0.0, 1G = 1.0 , >1.5G = 0.0)
	float Accel_weight = constrain(1 - 2*abs(1 - Accel_magnitude),0,1);  //  
